...
class SinkAdapter:
    ...
    def __call__(self, req, resp, engine) -> Any:
...
class JSONTranslator:
    ...
    def process_request(self, req, resp):
        ...
        try:
            req.context.doc = json.loads(body.decode('urf-8'))
...
class ThingsResource:
    ...
    def on_get(self, req, resp, user_id):
        ...
        limit = req.get_param_as_init('limit') or 50
        ...
        try:
            ...
            raise falcon.HTTPServiceUnavailable(
                ...
                description=description, retry_after=30
            )
    ...
    def on_post(self, req, resp, user_id):
        ...
        resp_location = '/%s/things/%s' % (user_id, proper_thing['id'])
